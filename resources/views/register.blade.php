        ...
        <div class="card card-body bg-dark text-white p-5" style="border-radius: 1rem;">
            <form action="/register-process" method="post" class="mb-md-5 px-5">
                ...
                <div class="form-outline form-white mb-4">
                    ...
                    <input type="name" name="account_name" id="account_name" class="form-control form px-5-control-lg" required>
                </div>

                <div class="form-outline form-white mb-4">
                    <label class="form-label" for="account_email">Email</label>
                    <input type="email" name="account_email" id="account_email" class="form-control form px-5-control-lg" required>
                </div>

                <div class="form-outline form-white mb-4">
                    <label class="form-label" for="account_password">Password</label>
                    <input type="password" name="account_password" id="account_password" class="form-control form px-5-control-lg" required>
                </div>

                <div class="form-outline form-white mb-4">
                    <label class="form-label" for="cPassword_field">Confirm Password</label>
                    <input type="password" name="account_cPassword" id="cPassword_field" class="form-control form px-5-control-lg" required>
                </div>
